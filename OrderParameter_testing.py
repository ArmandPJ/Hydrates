...
for iframe in range(num_frames):
    ...
    # only store atoms with z between 39 and 58 in layer_atom_positions *** (NEED TO: take parameters to set these boundaries manually) ***
    ...
    atoms_per_nn_distance = int(np.floor(layer_num_atoms/rnn))*2
